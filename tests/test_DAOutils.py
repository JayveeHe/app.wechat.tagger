...
class TestFlaskApp(unittest.TestCase):
    ...
    def test_insert_reaction(self):
        get_data = {'openid': 'foo', 'media_id': 'bar', 'redirect_url': 'http://trysenz.com'}
